...
def data_processing(path):
    ...
    newData[:, c] = col1;c = c + 1                                           # 1
    newData[:,c:c+w2] = col2.reshape((rowCount, w2)); c=c+w2                  # 2
    newData[:, c] = col3; c = c + 1                                          # 3
    newData[:, c:c + w4] = col4.reshape((rowCount, w4)); c = c + w4               # 4
    newData[:, c] = col5; c = c + 1                                          # 5
    newData[:, c:c + w6] = col6.reshape((rowCount, w6)); c = c + w6               # 6
    newData[:, c:c + w7] = col7.reshape((rowCount, w7)); c = c + w7               # 7
    newData[:, c:c + w8] = col8.reshape((rowCount, w8)); c = c + w8               # 8
...
if __name__ == '__main__':
    ...
    # Save to csv file
    save_path = "./raw_data/newData.csv"
    ...
    # test get bias
    bias_data = get_bias(data,"relationship")
