...
def main():
    ...
    custom_loader = CMNIST.WholeDataLoader(option, istrain=True)
    trainval_loader = torch.utils.data.DataLoader(custom_loader,
                                                  batch_size=option.batch_size,
                                                  shuffle=True,
                                                  num_workers=option.num_workers, pin_memory=True)

    custom_loader_test = CMNIST.WholeDataLoader(option, istrain=False)
